...
public class FromActivity extends AppCompatActivity {
    ...
    public void updateView() {
        ...
        if (currencies.size() > 0) {
            ...
            TextView[][] namesAndPrices = new TextView[currencies.size()][2];
            ...
            for (Currency currency : currencies) {
                ...
                // Creates the two TextViews for the currency's name and price
    ...
    private class ButtonHandler implements View.OnClickListener {
        public void onClick(View v) {
            ...
            TextView nameTV = (TextView) findViewById(10 * currencyId);
            TextView priceTV = (TextView) findViewById(10 * currencyId + 1);
            String name = nameTV.getText().toString();
            String priceString = priceTV.getText().toString();

            //No try{} here because the data is already tested in EditActivity
            double price = Double.parseDouble(priceString);
            dbManager.updateById(currencyId, name, price);
            Toast.makeText(FromActivity.this, "Currency chosen",
                    Toast.LENGTH_SHORT).show();

            //Sets the fields for the chosen currency in the MainActivity instance
            MainActivity.currency = new Currency(currencyId, name, price);
        }
    }
}
